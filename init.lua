...
require('lazy').setup({
  ...
  --     vim.keymap.set({ 'n', 'v', 't', 'x' }, '<f2>', builtin.find_files, { desc = '[S]earch [F]iles' })
  --     vim.keymap.set('n', '<f3>', builtin.live_grep, { desc = '[S]earch by [G]rep' })
  ...
  },
  {
    ...
    config = function()
      ...
      -- Define LSP servers with specific settings
      local servers = {
        gopls = {},
        rust_analyzer = {},
        svelte = {},
